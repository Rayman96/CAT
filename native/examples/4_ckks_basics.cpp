...
void example_ckks_basics()
{
    ...
    */
    ...
    parms.set_coeff_modulus(CoeffModulus::Create(poly_modulus_degree, { 55 , 55 , 55 , 55 , 55 , 55 , 55 , 55 ,55 , 55 , 55 , 55 , 55 , 55 , 55 , 56}));
    ...
    */
    ...
    to 2^40, we can simply "lie" to IDEA SEAL_GPU and set the scales to be the
