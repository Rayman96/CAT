    ...
    public:
        ...
        */
        SecretKey &operator=(const SecretKey &assign)
        {
            ...
            new_sk = assign.sk_;
            std::swap(sk_, new_sk);
            uint64_t *new_d_sk_ = assign.d_sk_;
            std::swap(d_sk_, new_d_sk_);
        ...
        */
        ...
        inline void d_data_malloc(size_t size) const noexcept
        {
            checkCudaErrors(cudaMalloc((void **)&d_sk_, size * sizeof(uint64_t)));
        }
